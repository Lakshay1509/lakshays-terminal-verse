export class CommandHandler {
  ...
  private getAwards(): string[] {
    return [
      ...
      '   ├─ University Coding Society Core Member',
      '   └─ Best Innovation Award - College Tech Fest',
      ''
    ];
  }
